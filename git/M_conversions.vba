...
'Ulozenie hodnot z pomocnych premennych do prislusnych stlpcov vystupneho harku na riadku "i"
    If j > 0 Then
        With PBL_outputWs
            .Cells(i, 20).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(obsValue)
            .Cells(i, 4).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(counterpartArea)
            .Cells(i, 5).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(refSector)
            .Cells(i, 6).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(counterpartSector)
            .Cells(i, 7).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(consolidation)
            .Cells(i, 8).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(accountingEntry)
            .Cells(i, 9).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(sto)
            .Cells(i, 10).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(instrAsset)
            .Cells(i, 11).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(maturity)
            .Cells(i, 12).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(expenditure)
            .Cells(i, 13).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(unitMeasure)
            .Cells(i, 16).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(prices)
            .Cells(i, 19).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(timePeriod)
            .Cells(i, 21).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(obsStatus)
            .Cells(i, 22).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(confStatus)
            .Cells(i, 24).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(embargoDate)
            .Cells(i, 32).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(refYearPrice)
            .Cells(i, 36).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(unitMult)
            .Cells(i, 41).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(gfsEcofunc)
            .Cells(i, 42).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(gfsTaxcat)
        End With
    Else
...
'Ulozenie hodnot z pomocnych premennych do prislusnych stlpcov vystupneho harku na riadku "i"
    If j > 0 Then
        With PBL_outputWs
            .Cells(i, 20).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(obsValue)
            .Cells(i, 9).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(sto)
            .Cells(i, 18).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(custBreakdown)
            .Cells(i, 19).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(timePeriod)
            .Cells(i, 21).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(obsStatus)
            .Cells(i, 22).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(confStatus)
            .Cells(i, 31).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(custBreakdownLb)
            .Cells(i, 41).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(gfsEcofunc)
            .Cells(i, 42).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(gfsTaxcat)
        End With
    Else
...
'Ulozenie hodnot z pomocnych premennych do prislusnych stlpcov vystupneho harku na riadku "i"
    If j > 0 Then
        With PBL_outputWs
            .Cells(i, 14).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(obsValue)
            .Cells(i, 2).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(refArea)
            .Cells(i, 6).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(accountingEntry)
            .Cells(i, 7).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(sto)
            .Cells(i, 8).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(activity)
            .Cells(i, 9).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(valuation)
            .Cells(i, 10).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(prices)
            .Cells(i, 11).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(unitMeasure)
            .Cells(i, 12).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(transformation)
            .Cells(i, 15).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(obsStatus)
            .Cells(i, 16).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(confStatus)
            .Cells(i, 27).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(unitMult)
        End With
    Else
        PBL_conversionFail = IncrementConversions(PBL_FAIL)
...
'Ulozenie hodnot z pomocnych premennych do prislusnych stlpcov vystupneho harku na riadku "i"
    If j > 0 Then
        With PBL_outputWs
            .Cells(i, 12).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(obsValue)
            .Cells(i, 3).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(counterpartArea)
            .Cells(i, 4).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(refSector)
            .Cells(i, 6).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(sto)
            .Cells(i, 7).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(instrAsset)
            .Cells(i, 8).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(pensionFundtype)
            .Cells(i, 13).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(obsStatus)
            .Cells(i, 14).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(confStatus)
        End With
    Else
        PBL_conversionFail = IncrementConversions(PBL_FAIL)
...
'Ulozenie hodnot z pomocnych premennych do prislusnych stlpcov vystupneho harku na riadku "i"
    If j > 0 Then
        With PBL_outputWs
            .Cells(i, 16).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(obsValue)
            .Cells(i, 4).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(counterpartArea)
            .Cells(i, 5).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(refSector)
            .Cells(i, 7).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(accountingEntry)
            .Cells(i, 8).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(sto)
            .Cells(i, 9).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(instrAsset)
            .Cells(i, 10).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(activity)
            .Cells(i, 11).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(expenditure)
            .Cells(i, 12).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(unitMeasure)
            .Cells(i, 13).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(prices)
            .Cells(i, 15).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(timePeriod)
            .Cells(i, 17).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(obsStatus)
            .Cells(i, 18).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(confStatus)
            .Cells(i, 30).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(unitMult)
        End With
    Else
        PBL_conversionFail = IncrementConversions(PBL_FAIL)
...
'Ulozenie hodnot z pomocnych premennych do prislusnych stlpcov vystupneho harku na riadku "i"
    If j > 0 Then
        With PBL_outputWs
            .Cells(i, 17).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(obsValue)
            .Cells(i, 7).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(sto)
            .Cells(i, 6).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(accountingEntry)
            .Cells(i, 4).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(refSector)
            .Cells(i, 3).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(counterpartArea)
            .Cells(i, 13).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(valuation)
            .Cells(i, 33).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(custBreakdownLb)
            .Cells(i, 15).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(custBreakdown)
            .Cells(i, 8).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(activity)
            .Cells(i, 9).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(activityTo)
            .Cells(i, 10).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(product)
            .Cells(i, 11).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(productTo)
            .Cells(i, 16).Resize(UBound(obsValue) + 1, 1).Value = transposeArray(timePeriod)
        End With
    Else
        PBL_conversionFail = IncrementConversions(PBL_FAIL)
