...
Public Const C_OK = "OK"
Public Const C_FAIL = "FAIL"
...
Public conversionOk As Integer
Public conversionFail As Integer
    ...
    If fileToOpen <> False Then
        ...
        Else
            ...
            For i = 1 To UBound(inputWsId)
                ...
                workbookName = Left(inputWb.name, (InStrRev(inputWb.name, ".", -1, vbTextCompare) - 1))
                worksheetName = inputWs.name
                ...
                If conversionCheck = True Then
                    ...
                    errorIndi = conversionFail
                                    
                    Call arrayPush(conversionType)
                    Call defineConversion(conversionType)
                    
                    If errorIndi = conversionFail Then
                        Call arrayFill(conversionType)
                        incrementConversions (C_OK)
                    End If
                
                Else
                    errorMsg = "Zvolený hárok - """ & worksheetName & """ nemá správny formát alebo bol zvolený nesprávny typ konverzie!" & vbNewLine & vbNewLine
